...
export const MONSTER_DEFS: MonsterDef[] = [
  ...
  // ── 小史萊姆 (Tier 1) ──────────────────────────────────
  {
    ...
    hp: 87, atk: 18, speed: 90, exp: 15, gold: 5,
  ...
  },
  {
    ...
    hp: 83, atk: 18, speed: 85, exp: 18, gold: 6,
  ...
  },
  {
    ...
    hp: 85, atk: 18, speed: 100, exp: 15, gold: 5,
  ...
  },
  {
    ...
    hp: 91, atk: 18, speed: 90, exp: 12, gold: 4,
  ...
  // ── 殭屍史萊姆小 / 熔岩史萊姆小 ───────────────────
  {
    ...
    hp: 89, atk: 18, speed: 70, exp: 20, gold: 7,
  ...
  },
  {
    ...
    hp: 86, atk: 18, speed: 100, exp: 22, gold: 8,
  ...
  // ── 菁英史萊姆 Tier 3 ──────────────────────────────────
  {
    ...
    hp: 87, atk: 18, speed: 95, exp: 60, gold: 25,
  ...
  },
  {
    ...
    hp: 83, atk: 18, speed: 90, exp: 65, gold: 28,
  ...
  },
  {
    ...
    hp: 85, atk: 18, speed: 110, exp: 60, gold: 25,
  ...
  },
  {
    ...
    hp: 91, atk: 18, speed: 95, exp: 55, gold: 22,
  ...
  },
  {
    ...
    hp: 89, atk: 18, speed: 78, exp: 75, gold: 32,
  ...
  },
  {
    ...
    hp: 86, atk: 18, speed: 110, exp: 80, gold: 36,
  ...
  // ── 花怪小怪 Tier 2 (minStar=2) ────────────────────────
  {
    ...
    hp: 82, atk: 21, speed: 0, exp: 28, gold: 10,
  ...
  },
  {
    ...
    hp: 80, atk: 21, speed: 0, exp: 30, gold: 11,
  ...
  },
  {
    ...
    hp: 79, atk: 21, speed: 0, exp: 32, gold: 12,
  ...
  // ── 花怪菁英 Tier 3 (minStar=2) ─────────────────────────
  {
    ...
    hp: 82, atk: 21, speed: 0, exp: 90, gold: 38,
  ...
  },
  {
    ...
    hp: 80, atk: 21, speed: 0, exp: 95, gold: 40,
  ...
  },
  {
    ...
    hp: 79, atk: 21, speed: 0, exp: 100, gold: 42,
  ...
  // ── 獸人小怪 Tier 1 (minStar=3) ───────────────────────
  {
    ...
    hp: 95, atk: 20, speed: 80, exp: 35, gold: 12,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 1, minStar: 3,
    hp: 96, atk: 20, speed: 85, exp: 38, gold: 13,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 1, minStar: 3,
    hp: 94, atk: 20, speed: 90, exp: 40, gold: 14,
  ...
  // ── 獸人菁英 Tier 3 (minStar=3) ────────────────────────
  {
    ...
    hp: 95, atk: 20, speed: 85, exp: 110, gold: 45,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 3, minStar: 3,
    hp: 96, atk: 20, speed: 90, exp: 115, gold: 48,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 3, minStar: 3,
    hp: 94, atk: 20, speed: 95, exp: 120, gold: 50,
  ...
  // ── 史萊姆王 Tier 5 ────────────────────────────────────
  {
    ...
    hp: 825, atk: 26, def: 18, speed: 80, exp: 200, gold: 100,
  ...
  },
  {
    ...
    hp: 800, atk: 26, def: 18, speed: 80, exp: 200, gold: 100,
  ...
  },
  {
    ...
    hp: 840, atk: 26, def: 18, speed: 80, exp: 200, gold: 100,
  ...
  },
  {
    ...
    hp: 855, atk: 26, def: 24, speed: 80, exp: 200, gold: 100,
  ...
  },
  {
    ...
    hp: 866, atk: 26, def: 20, speed: 80, exp: 220, gold: 120,
  ...
  },
  {
    ...
    hp: 784, atk: 26, def: 30, speed: 80, exp: 250, gold: 150,
...

  {
    ...
    element: 'none', tint: 0xffffff, tier: 5,
    hp: 916, atk: 27, def: 19, speed: 85, exp: 295, gold: 175,
...

  {
    ...
    element: 'none', tint: 0xffffff, tier: 5,
    hp: 883, atk: 27, def: 15, speed: 105, exp: 300, gold: 180,
  ...
  // ── 吸血鬼小怪 Tier 1 (minStar=4) ──────────────────────
  {
    ...
    hp: 87, atk: 21, def: 5, speed: 85, exp: 40, gold: 15,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 1, minStar: 4,
    hp: 91, atk: 21, def: 6, speed: 90, exp: 42, gold: 16,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 1, minStar: 4,
    hp: 83, atk: 21, def: 5, speed: 95, exp: 45, gold: 17,
  ...
  // ── 吸血鬼菁英 Tier 3 (minStar=4) ───────────────────────
  {
    ...
    hp: 87, atk: 21, def: 8, speed: 88, exp: 125, gold: 55,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 3, minStar: 4,
    hp: 91, atk: 21, def: 9, speed: 93, exp: 130, gold: 58,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 3, minStar: 4,
    hp: 83, atk: 21, def: 8, speed: 98, exp: 135, gold: 60,
  ...
  // ── 吸血鬼Boss系列 (minStar=4) ──────────────────────────
  {
    ...
    element: 'none', tint: 0xffffff, tier: 5,
    hp: 820, atk: 29, def: 25, speed: 100, exp: 320, gold: 200,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 5,
    hp: 850, atk: 29, def: 27, speed: 92, exp: 335, gold: 210,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 5,
    hp: 790, atk: 29, def: 21, speed: 108, exp: 350, gold: 220,
  ...
  // ── 花Boss系列 ──────────────────────────────────────────
  {
    ...
    hp: 780, atk: 29, def: 14, speed: 0, exp: 200, gold: 110,
  ...
  },
  {
    ...
    element: 'grass', tint: 0xffffff, tier: 5,
    hp: 760, atk: 29, def: 14, speed: 0, exp: 210, gold: 115,
  ...
  },
  {
    ...
    element: 'fire', tint: 0xffffff, tier: 5,
    hp: 750, atk: 29, def: 7, speed: 0, exp: 220, gold: 120,
...
export const CARD_DEFS: CardDef[] = [
  ...
  { id: 'card_slime_blue_b', name: '藍史萊姆王卡', monsterId: 'boss_slime_blue',
    ...
    desc: '受擊18%機率觸發護盾2秒  受傷-12%  敵人HP<12%直接斬殺' },
  ...
  { id: 'card_slime_zombie_b', name: '殭屍史萊姆王卡', monsterId: 'boss_zombie_slime',
    ...
    desc: '燃燒傷害+20%  全傷害+12%  對燃燒中敵人傷+28%  燃燒堆疊+3' },
  ...
  { id: 'card_plant2_b', name: '藤蔓花王卡', monsterId: 'boss_flower_two',
    ...
    desc: '迴避率+14%  攻擊力+15  血量<40%時攻擊額外+30' },
  ...
  { id: 'card_plant3_b', name: '不死花王卡', monsterId: 'boss_flower_three',
    ...
    desc: '召喚物傷+50%  友軍花怪上限+2  召喚物血量+35%' },
  ...
  { id: 'card_orc1_n', name: '獸人卡', monsterId: 'orc1_s',
    ...
    desc: '攻擊力+6 每1%暴擊率→+0.3攻擊 （暴擊判定關閉）' },
  { id: 'card_orc1_e', name: '菁英獸人卡', monsterId: 'elite_orc1',
    ...
    desc: '攻擊力+11 每1%暴擊率→+0.7攻擊 （暴擊判定關閉）' },
  { id: 'card_orc1_b', name: '獸人族長卡', monsterId: 'boss_orc1',
    ...
    desc: '攻擊力+30  每1%暴擊率→+2.2攻擊  全傷害+15%（暴擊判定關閉）' },
  ...
  { id: 'card_orc2_e', name: '菁英獸人戰士卡', monsterId: 'elite_orc2',
    ...
    desc: '受擊11%觸發業火盾 ATK+22%持續1.5秒  最大HP+25' },
  { id: 'card_orc2_b', name: '獸人戰士長卡', monsterId: 'boss_orc2',
    ...
    desc: '受擊28%觸發業火盾 ATK+72%持續2.5秒 觸發時回復10%HP' },
  ...
  { id: 'card_orc3_b', name: '獸人武士長卡', monsterId: 'boss_orc3',
    ...
    desc: '每3次攻擊蓄勁，第4刀+160%傷害  攻擊速度+12%' },
  ...
  { id: 'card_vampire3_b', name: '血族魔王卡', monsterId: 'boss_vampire3',
    ...
    desc: '單次受傷上限35%最大HP  回血速+2.0/s  迴避率+8%' },
];
