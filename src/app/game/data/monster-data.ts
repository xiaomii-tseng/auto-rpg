...
export const MONSTER_DEFS: MonsterDef[] = [
  ...
  // ── 菁英史萊姆 Tier 3 ──────────────────────────────────
  {
    ...
    cards: [{ cardId: 'card_elite_slime_zombie_b', rate: CR_E }, { cardId: 'card_elite_plant2_b', rate: CR_E }],
    drops: eliteDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_elite_slime_red_a', rate: CR_E }, { cardId: 'card_elite_slime_red_c', rate: CR_E }, { cardId: 'card_elite_plant3_a', rate: CR_E }],
    drops: eliteDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_elite_slime_blue_b', rate: CR_E }, { cardId: 'card_elite_plant3_b', rate: CR_E }, { cardId: 'card_elite_slime_green_b', rate: CR_E }],
    drops: eliteDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_elite_slime_white_c', rate: CR_E }, { cardId: 'card_elite_plant3_c', rate: CR_E }],
    drops: eliteDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_elite_plant1_c', rate: CR_E }, { cardId: 'card_elite_slime_zombie_c', rate: CR_E }],
    drops: eliteDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_elite_slime_lava_b', rate: CR_E }, { cardId: 'card_elite_slime_red_b', rate: CR_E }],
    drops: eliteDrops,
  },
  ...
  // ── 花怪菁英 Tier 3 (minStar=2) ─────────────────────────
  {
    ...
    cards: [{ cardId: 'card_elite_plant1_a', rate: CR_E }, { cardId: 'card_elite_plant1_b', rate: CR_E }],
    drops: eliteDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_elite_plant2_c', rate: CR_E }, { cardId: 'card_elite_slime_blue_c', rate: CR_E }],
    drops: eliteDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_elite_slime_white_b', rate: CR_E }, { cardId: 'card_elite_slime_green_c', rate: CR_E }],
    drops: eliteDrops,
  },
  ...
  // ── 史萊姆王 Tier 5 (Slime1 精靈) ──────────────────────
  {
    ...
    cards: [{ cardId: 'card_boss_slime_red_b', rate: CR_B }, { cardId: 'card_boss_flower_two_c', rate: CR_B }],
    drops: bossDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_boss_slime_white_c', rate: CR_B }],
    drops: bossDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_boss_slime_green_b', rate: CR_B }, { cardId: 'card_boss_lava_slime_a', rate: CR_B }],
    drops: bossDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_boss_flower_three_b', rate: CR_B }, { cardId: 'card_boss_slime_green_a', rate: CR_B }],
    drops: bossDrops,
  },
  ...
  // ── 殭屍史萊姆王 (Slime2 精靈) ─────────────────────────
  {
    ...
    cards: [{ cardId: 'card_boss_slime_white_a', rate: CR_B }, { cardId: 'card_boss_flower_three_a', rate: CR_B }],
    drops: bossDrops,
  },
  ...
  // ── 熔岩史萊姆王 (Slime3 精靈) ─────────────────────────
  {
    ...
    cards: [{ cardId: 'card_boss_slime_blue_c', rate: CR_B }],
    drops: bossDrops,
  },
  ...
  // ── 花Boss系列 ──────────────────────────────────────────
  {
    ...
    cards: [{ cardId: 'card_boss_slime_red_a', rate: CR_B }],
    drops: bossDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_boss_zombie_slime_a', rate: CR_B }],
    drops: bossDrops,
  },
  {
    ...
    cards: [{ cardId: 'card_boss_flower_one_a', rate: CR_B }, { cardId: 'card_boss_flower_three_c', rate: CR_B }],
    drops: bossDrops,
  },
];
...
export const CARD_DEFS: CardDef[] = [
  ...
  // ── 菁英史萊姆卡 A/B/C ──
  { id: 'card_elite_slime_green_b', name: '綠史萊姆菁英卡片A', monsterId: 'elite_slime_green', element: 'none', tint: 0x00ff88, effect: { atk: 8 }, desc: '攻擊力+8' },
  { id: 'card_elite_slime_green_c', name: '綠史萊姆菁英卡片B', monsterId: 'elite_slime_green', element: 'none', tint: 0x00ff88, effect: { dmgVsAnyElement: 0.05 }, desc: '對火/水/草屬性傷害+5%' },
  ...
  { id: 'card_elite_slime_blue_b', name: '藍史萊姆菁英卡片A', monsterId: 'elite_slime_blue', element: 'none', tint: 0x00ddff, effect: { speed: 18 }, desc: '移動速度+18' },
  { id: 'card_elite_slime_blue_c', name: '藍史萊姆菁英卡片B', monsterId: 'elite_slime_blue', element: 'none', tint: 0x00ddff, effect: { hp: 30, weaponEnhance8Hp: 30 }, desc: '最大HP+30 武器≥+8時最大HP再+30' },

  { id: 'card_elite_slime_white_b', name: '白史萊姆菁英卡片A', monsterId: 'elite_slime_white', element: 'none', tint: 0xaaccdd, effect: { penetration: 30 }, desc: '穿甲+30' },
  { id: 'card_elite_slime_white_c', name: '白史萊姆菁英卡片B', monsterId: 'elite_slime_white', element: 'none', tint: 0xaaccdd, effect: { dmgVsEliteOrBoss: 0.10 }, desc: '對菁英/Boss傷害+10%' },

  { id: 'card_elite_slime_zombie_b', name: '殭屍史萊姆菁英卡片A', monsterId: 'elite_slime_zombie', element: 'none', tint: 0xccff44, effect: { dotBonus: 0.045 }, desc: '燃燒傷害+4.5%' },
  { id: 'card_elite_slime_zombie_c', name: '殭屍史萊姆菁英卡片B', monsterId: 'elite_slime_zombie', element: 'none', tint: 0xccff44, effect: { dotBonus: 0.03, weaponEnhance8DotBonus: 0.03 }, desc: '燃燒傷害+3% 武器≥+8時燃燒傷害再+3%' },

  { id: 'card_elite_slime_lava_b', name: '熔岩史萊姆菁英卡片A', monsterId: 'elite_slime_lava', element: 'none', tint: 0xff4400, effect: { dmgVsNone: 0.08 }, desc: '對無屬性傷害+8%' },
  ...
  { id: 'card_elite_plant2_b', name: '菁英藤蔓花卡片A', monsterId: 'elite_plant2', element: 'water', tint: 0x66ff88, effect: { evasion: 0.03, hp: 30 }, desc: '閃避率+3% 最大HP+30' },
  { id: 'card_elite_plant2_c', name: '菁英藤蔓花卡片B', monsterId: 'elite_plant2', element: 'water', tint: 0x66ff88, effect: { atk: 6, weaponEnhance8Atk: 6 }, desc: '攻擊力+6 武器≥+8時攻擊力再+6' },
  ...
  // 藍史萊姆王：瞬步斬 / 風刃 / 旋風斬
  { id: 'card_boss_slime_blue_c', name: '藍史萊姆王卡片A', monsterId: 'boss_slime_blue', element: 'none', tint: 0x44aaff, effect: { speed: 50, maxHpPct: -0.20 }, desc: '移動速度+50 最大HP-20%' },
  ...
  { id: 'card_boss_slime_white_c', name: '白史萊姆王卡片B', monsterId: 'boss_slime_white', element: 'none', tint: 0xaaaaaa, effect: { hp: 30, weaponRefineHp: 30 }, desc: 'HP+30 武器每精煉+2、HP再+30' },
  ...
  { id: 'card_boss_flower_three_b', name: '殭屍史萊姆王卡片B', monsterId: 'boss_zombie_slime', element: 'none', tint: 0x88aa44, effect: { infiniteDivineShield: 1 }, desc: '無限神盾護體(DEF+20)' },
  ...
  // 藤蔓花王：陷阱特化
  { id: 'card_boss_flower_two_c', name: '藤蔓花王卡片A', monsterId: 'boss_flower_two', element: 'none', tint: 0x66ff88, effect: { dmgVsEliteOrBoss: 0.25 }, desc: '對Boss/菁英傷害+25%' },
  ...
  { id: 'card_boss_flower_three_c', name: '不死花王卡片B', monsterId: 'boss_flower_three', element: 'none', tint: 0xffaa44, effect: { executeBelow15: 1 }, desc: '敵人HP低於15%時直接斬殺' },
];
