...
export const CARD_DEFS: CardDef[] = [
  ...
  { id: 'card_elite_plant2_a', name: '菁英藤蔓花卡片(A)', monsterId: 'elite_plant2', element: 'water', tint: 0x66ff88, effect: { summonFlowerChance: 0.10, summonFlowerCapPair: 1 }, desc: '每次命中有10%機率召喚1朵友軍不死花（ATK×35%、HP×100%，穿透，存活15秒，0.8秒攻擊一次，對BOSS傷害-50%）。攜帶2張時機率提升至20%，友軍上限+1（基礎2→3）' },
  ...
  // 藤蔓花王：陷阱特化
  { id: 'card_boss_flower_two_a', name: '藤蔓花王卡片(A)', monsterId: 'boss_flower_two', element: 'none', tint: 0x66ff88, effect: { flowerSummonMode: 1, summonFlowerCap: 1 }, desc: '取消原本攻擊模式，改為召喚花怪攻擊（ATK×35%、HP×100%，穿透，0.8秒攻擊一次，對BOSS傷害-50%）。召喚物上限+1' },
