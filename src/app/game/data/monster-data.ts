...
export const MONSTER_DEFS: MonsterDef[] = [
  ...
  // ── 小史萊姆 (Tier 1) ──────────────────────────────────
  {
    ...
    hp: 87, atk: 18, def: 5, speed: 90, exp: 30, gold: 5,
  ...
  },
  {
    ...
    hp: 83, atk: 18, def: 5, speed: 85, exp: 30, gold: 6,
  ...
  },
  {
    ...
    hp: 85, atk: 18, def: 5, speed: 100, exp: 30, gold: 5,
  ...
  },
  {
    ...
    hp: 91, atk: 18, def: 5, speed: 90, exp: 30, gold: 4,
  ...
  // ── 殭屍史萊姆小 / 熔岩史萊姆小 ───────────────────
  {
    ...
    hp: 89, atk: 18, def: 5, speed: 70, exp: 30, gold: 7,
  ...
  },
  {
    ...
    hp: 86, atk: 18, def: 5, speed: 100, exp: 30, gold: 8,
  ...
  // ── 菁英史萊姆 Tier 3 ──────────────────────────────────
  {
    ...
    hp: 87, atk: 18, def: 8, speed: 95, exp: 75, gold: 25,
  ...
  },
  {
    ...
    hp: 83, atk: 18, def: 8, speed: 90, exp: 75, gold: 28,
  ...
  },
  {
    ...
    hp: 85, atk: 18, def: 8, speed: 110, exp: 75, gold: 25,
  ...
  },
  {
    ...
    hp: 91, atk: 18, def: 8, speed: 95, exp: 75, gold: 22,
  ...
  },
  {
    ...
    hp: 89, atk: 18, def: 8, speed: 78, exp: 75, gold: 32,
  ...
  },
  {
    ...
    hp: 86, atk: 18, def: 8, speed: 110, exp: 75, gold: 36,
  ...
  // ── 花怪小怪 Tier 2 (minStar=2) ────────────────────────
  {
    ...
    hp: 82, atk: 21, def: 1, speed: 0, exp: 30, gold: 10,
  ...
  },
  {
    ...
    hp: 80, atk: 21, def: 1, speed: 0, exp: 30, gold: 11,
  ...
  },
  {
    ...
    hp: 79, atk: 21, def: 1, speed: 0, exp: 30, gold: 12,
  ...
  // ── 花怪菁英 Tier 3 (minStar=2) ─────────────────────────
  {
    ...
    hp: 82, atk: 21, def: 2, speed: 0, exp: 75, gold: 38,
  ...
  },
  {
    ...
    hp: 80, atk: 21, def: 2, speed: 0, exp: 75, gold: 40,
  ...
  },
  {
    ...
    hp: 79, atk: 21, def: 2, speed: 0, exp: 75, gold: 42,
  ...
  // ── 獸人小怪 Tier 1 (minStar=3) ───────────────────────
  {
    ...
    hp: 95, atk: 20, def: 8, speed: 80, exp: 30, gold: 12,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 1, minStar: 3,
    hp: 96, atk: 20, def: 8, speed: 85, exp: 30, gold: 13,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 1, minStar: 3,
    hp: 94, atk: 20, def: 8, speed: 90, exp: 30, gold: 14,
  ...
  // ── 獸人菁英 Tier 3 (minStar=3) ────────────────────────
  {
    ...
    hp: 95, atk: 20, def: 14, speed: 85, exp: 75, gold: 45,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 3, minStar: 3,
    hp: 96, atk: 20, def: 14, speed: 90, exp: 75, gold: 48,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 3, minStar: 3,
    hp: 94, atk: 20, def: 14, speed: 95, exp: 75, gold: 50,
  ...
  // ── 吸血鬼小怪 Tier 1 (minStar=4) ──────────────────────
  {
    ...
    hp: 87, atk: 21, def: 3, speed: 85, exp: 30, gold: 15,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 1, minStar: 4,
    hp: 91, atk: 21, def: 3, speed: 90, exp: 30, gold: 16,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 1, minStar: 4,
    hp: 83, atk: 21, def: 3, speed: 95, exp: 30, gold: 17,
  ...
  // ── 吸血鬼菁英 Tier 3 (minStar=4) ───────────────────────
  {
    ...
    hp: 87, atk: 21, def: 5, speed: 88, exp: 75, gold: 55,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 3, minStar: 4,
    hp: 91, atk: 21, def: 5, speed: 93, exp: 75, gold: 58,
  ...
  },
  {
    ...
    element: 'none', tint: 0xffffff, tier: 3, minStar: 4,
    hp: 83, atk: 21, def: 5, speed: 98, exp: 75, gold: 60,
